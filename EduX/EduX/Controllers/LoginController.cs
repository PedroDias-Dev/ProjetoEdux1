    ...
    public class LoginController : ControllerBase
    {
        ...
        private string GenerateJSONWebToken(Usuario userInfo)
        {
            ...
            var claims = new[] {
                ...
                //new Claim("conquistasOcultas", userInfo.ConquistasOcultas),
                //new Claim("conquistasTotais", userInfo.ConquistasTotais),
                //new Claim("curtidasTotais", userInfo.CurtidasTotais),
                //new Claim("postagensTotais", userInfo.PostagensTotais),
