...
namespace EduX.Controllers
{
    ...
    public class CurtidaController : ControllerBase
    {
        ...
        [HttpGet("/search/{Iddica}")]
        public IActionResult GetByDica(Guid Iddica)
        {
            try
            {
                var curtidas = curtidaRepository.BuscarPorIdDica(Iddica);
        ...
        public IActionResult Post(Curtida curtida)
        {
            try
            {
                ...
                var count = curtidaRepository.BuscarPorIdDica(curtida.IdDica);
