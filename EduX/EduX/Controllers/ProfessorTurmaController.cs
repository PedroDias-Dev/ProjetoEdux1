...
namespace EduX.Controllers
{
    ...
    public class ProfessorTurmaContoller : ControllerBase
    {
        ...
        /// <summary>
        /// Mostra todas os professores cadastrados
        /// </summary>
        ...
        [HttpPost]
        public IActionResult Post(ProfessorTurma professorT)
        {
            try
            {
        ...
        /// <param name="professorT">Objeto professor com as alterações</param>
        /// <returns>Info do professor alterado</returns>
        [HttpPut("{id}")]
        public IActionResult Put(Guid id, [FromForm]ProfessorTurma professorT)
        {
            try
            {
                //edita professor
