    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public async Task<ActionResult<Usuario>> Get(Guid id)
        {
            try
            {
                ...
                int ConquistasOcultasUser = Convert.ToInt32(usuario.ConquistasOcultas);
                int CurtidasTotaisUser = Convert.ToInt32(usuario.CurtidasTotais);
                int PostagensTotaisUser = Convert.ToInt32(usuario.PostagensTotais);

                int ConquistasTotaisUser = Convert.ToInt32(usuario.ConquistasTotais);
                ConquistasTotaisUser = ConquistasOcultasUser + CurtidasTotaisUser + PostagensTotaisUser;

                usuario.ConquistasTotais = ConquistasTotaisUser.ToString();
        ...
        [HttpPatch("{id}")]
        public async Task<IActionResult> Patch(Guid id, Usuario usuario)
        {
            try
            {
                //Edita o usuario
                _userRepository.RegistrarConquista(usuario);
