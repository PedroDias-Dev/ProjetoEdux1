...
namespace EduX.Domains
{
    public partial class Usuario
    {
        ...
        public string PostagensTotais { get; set; }
        public string CurtidasTotais { get; set; }

        public string ConquistasOcultas { get; set; }
        public string ConquistasTotais { get; set; }
